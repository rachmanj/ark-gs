          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                <th scope="row">1</th>
                <td>011C</td>
                <td class="text-right">@if ($npi_incoming_011 && $npi_outgoing_011)
              ...
              <tr>
                <th scope="row">2</th>
                <td>017C</td>
                <td class="text-right">@if ($npi_incoming_017 && $npi_outgoing_017)
              ...
              <tr>
                <th scope="row">3</th>
                <td>APS</td>
                <td class="text-right">@if ($npi_incoming_APS && $npi_outgoing_APS)
