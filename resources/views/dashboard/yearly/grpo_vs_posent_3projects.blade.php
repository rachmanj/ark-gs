        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              <th scope="row"></th>
              <th>Total</th>
              <th class="text-right">{{ number_format($po_sent_three / 1000, 2) }}</th>
              <th class="text-right">{{ number_format($grpo_amount_three / 1000, 2) }}</th>
              <th class="text-center">{{ $grpo_amount_three == 0 ? ' - ' : number_format( $grpo_amount_three / $po_sent_three * 100, 2) }}</th>
            </tr>
          </tbody>
        </table>
     </div>
