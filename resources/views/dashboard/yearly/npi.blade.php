          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                <th scope="row">3</th>
                <td>021C</td>
                <td class="text-right">{{ number_format($incoming_qty_021, 0) }}</td>
                <td class="text-right">{{ number_format($outgoing_qty_021, 0) }}</td>
                @if ($incoming_qty_021 && $outgoing_qty_021)
                <td class="text-right">{{ number_format($incoming_qty_021 / $outgoing_qty_021, 2) }}</td>
                @else
                <td class="text-right">na</td>
                @endif
                <td></td>
              ...
              <tr>
                <th scope="row">4</th>
                <td>022C</td>
                <td class="text-right">{{ number_format($incoming_qty_022, 0) }}</td>
                <td class="text-right">{{ number_format($outgoing_qty_022, 0) }}</td>
                @if ($incoming_qty_022 && $outgoing_qty_022)
                <td class="text-right">{{ number_format($incoming_qty_022 / $outgoing_qty_022, 2) }}</td>
                @else
                <td class="text-right">na</td>
                @endif
                <td></td>
              ...
              <tr>
                <th scope="row"></th>
                <th>Total</th>
                <th class="text-right">{{ number_format($incoming_qty_all, 0) }}</th>
                <th class="text-right">{{ number_format($outgoing_qty_all, 0) }}</th>
                <td class="text-right">@if ($incoming_qty_all && $outgoing_qty_all)
                    {{ number_format($incoming_qty_all / $outgoing_qty_all, 2) }}
                @endif</td>
                <td></td>
              </tr>
            </tbody>
