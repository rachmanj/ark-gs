          ...
          <div class="card">
            <div class="card-header">
              ...
              @role(['superadmin', 'admin'])
                ...
                <a href="{{ route('po20withetas.truncate') }}" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure you want to delete all records?')"><i class="icon-trash"></i> Truncate Table</a>
                @endrole
            </div>
            <div class="card-body">
              <div class="table-responsive">
              <table id="datatable-po20witheta" class="table table-bordered">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>PO</th>
    ...
    <div class="modal-dialog">
      <div class="modal-content animated rollIn">
        ...
        <div class="modal-body">
            <form method="post" action="{{ route('po20withetas.import_excel') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
...
<script>
    ...
    $('#datatable-po20witheta').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('po20withetas.data') }}',
            dom: 'Bfrtip',
            button: [
              {
                extend: 'pdf',
