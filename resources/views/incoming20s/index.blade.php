...
<div class="row">
    <div class="col-lg-12">
      <div> <!--Please remove the height before using this page  style="height:600px"-->
        <h3>Incoming Inventory YEARLY</h3>
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="datatable-incoming20s" class="table table-bordered">
                  <thead>
                      <tr>
                          <th>#</th>
                          <th>PostingD</th>
    ...
    <div class="modal-dialog">
      <div class="modal-content animated rollIn">
        ...
        <div class="modal-body">
            <form method="post" action="{{ route('incoming20s.import_excel') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
...
<script>
    ...
    $('#datatable-incoming20s').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('incoming20s.data') }}',
            dom: 'Bfrtip',
            button: [
              {
                extend: 'pdf',
