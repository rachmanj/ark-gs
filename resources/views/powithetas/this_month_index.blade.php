...
<div class="row">
    <div class="col-lg-12">
      <div> <!--Please remove the height before using this page  style="height:600px"-->
          <h3>PO Sent (Filtered)</h3>
          <p><strong>THIS MONTH</strong> | <a href="{{ route('powithetas.index') }}">This Year</a></p>
          ...
          <div class="card">
            <div class="card-header">
              @if (session('message'))
                ...
                @endif
                <a href="{{ route('powithetas.export_excel_this_month') }}" class="btn btn-outline-success btn-sm"><i class="fa fa-download"></i> Export This Month (filtered)</a>
                ...
                <a href="{{ route('powithetas.grpo_truncate') }}" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure you want to delete all records?')"><i class="icon-trash"></i> GRPO Truncate</a>
                @endrole
            </div>
            <div class="card-body">
